...
class PhysicssimEnv(gym.Env, utils.EzPickle):
  ...
  def __init__(self, init_pose=None, init_velocities=None, init_angle_velocities=None, runtime=5.):
    super(PhysicsSim, self).__init__(init_pose=None, init_velocities=None, init_angle_velocities=None, runtime=5.)
    ...
    # Action Space : Four rotors speed
    ...
    if self.continuous:
            ...
            # Nop, propeller 1, propeller 2, propeller 3, propeller 4
